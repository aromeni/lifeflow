...
export type PrivacySummary = components["schemas"]["PrivacySummaryResponse"];
export type ConnectionSummary = components["schemas"]["ConnectionSummaryView"];
export type GrantedScope = components["schemas"]["GrantedScopeView"];
