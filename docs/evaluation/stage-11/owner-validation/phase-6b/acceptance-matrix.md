...
| P6B-010 | Owner sends P6-CAL-TEST-02, Account B → Account A | Pending owner action |
| P6B-011 | Live configuration applied safely for the authorised window | Pending |
| P6B-012 | Account A reconnected via connector-consent only, OIDC sign-in never enabled | Pending |
| P6B-013 | Exactly one bounded manual sync | Pending |
| P6B-014 | Calendar acceptance envelope applied; no forced/edited proposal | Pending |
| P6B-015 | Exactly one Calendar insertion executed | Pending |
| P6B-016 | Owner verifies the event directly in Google Calendar | Pending |
| P6B-017 | Owner deletes the event manually; full cleanup and residue verification | Pending |
| P6B-018 | Decision recorded | Pending |
| P6B-019 | Evidence pack complete; full verification gate run | Pending |
| P6B-020 | PR opened against `main`, not merged, not tagged | Pending |
